 ...
 */
final class Version20220228142527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE navire ADD longueur INT NOT NULL, ADD largueur INT NOT NULL, ADD tirandeau DOUBLE PRECISION NOT NULL');
    }
