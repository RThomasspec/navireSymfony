 ...
 */
final class Version20220228142609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE navire CHANGE largueur largeur INT NOT NULL');
    }
